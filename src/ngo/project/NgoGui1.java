 ...
 */
public class NgoGui1 extends javax.swing.JFrame {
    int View;
    ArrayList<String> AMemberList= new ArrayList<String>();
    String TempName ;
    String TempId;
    ...
    public NgoGui1() throws IOException  {
        initComponents();
        Maketxtfile();
        Blacklist();
        showallorganization();
    ...
    private void initComponents() {
        ...
        MemberNamelbl.setText("Member FirstName");
        ...
        SearchMemberLayout.setHorizontalGroup(
                    ...
                    .addGroup(SearchMemberLayout.createSequentialGroup()
                        ...
                        .addGroup(SearchMemberLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(SearchMemberLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(SearchMemberLayout.createSequentialGroup()
                                    .addComponent(MemberPhonelbl2, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(MemberPositionTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(SearchMemberLayout.createSequentialGroup()
                                    .addComponent(MemberPhonelbl, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(SearchMemberLayout.createSequentialGroup()
                .addGap(36, 36, 36)
                .addComponent(Prevbtn, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(AddMemberLayout.createSequentialGroup()
                ...
                .addGroup(AddMemberLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(AddMemberLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(AddMemberAddresslbl, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        AddOrganizationLayout.setHorizontalGroup(
            ...
            .addGroup(AddOrganizationLayout.createSequentialGroup()
                .addGroup(AddOrganizationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(AddOrganizationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(AddOrganizationLayout.createSequentialGroup()
                                ...
                                .addGroup(AddOrganizationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(AddOrganizationEmailtxt, javax.swing.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
                                    .addComponent(AddOrganizationNametxt))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(AddOrganizationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(AddOrganizationLayout.createSequentialGroup()
                        .addGap(71, 71, 71)
                        .addComponent(AddnewOrganizationbtnsave, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(AddOrganizationLayout.createSequentialGroup()
                ...
                .addGroup(AddOrganizationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(AddOrganizationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(AddOrganizationAddressCitytxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(OrganizationAddressCitylbl, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(AddOrganizationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(AddOrganizationAddressProvincetxt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void DeleteFile(){
     ...
     EraseFile.close();
            ...
            Logger.getLogger(NgoGui1.class.getName()).log(Level.SEVERE, null, ex);
       ...
       private void FindMember() throws IOException{
        ...
        try{
            ...
            BrFM.readLine();
             while((Id = BrFM.readLine())!= null){
                ...
                if (Id.equalsIgnoreCase(SearchMembertxt.getText())||LastName.equalsIgnoreCase(SearchMembertxt.getText())||FirstName.equalsIgnoreCase(SearchMembertxt.getText())){ 
                  AMemberList.add(Id);
                  AMemberList.add(FirstName);
                  AMemberList.add(LastName);
                  AMemberList.add(BrFM.readLine());
                  AMemberList.add(BrFM.readLine());
                  AMemberList.add(BrFM.readLine());
                  AMemberList.add(BrFM.readLine());
                  AMemberList.add(BrFM.readLine());
            ...
            JOptionPane.showMessageDialog(null, "Member are not found");
                  ...
                  View = 0;
                  MemberIdTxt.setText(AMemberList.get(View));
                  View++;
                  MemberFirstNameTxt.setText(AMemberList.get(View));
                  View++;
                  MemberLastNameTxt.setText(AMemberList.get(View));
                  View++;
                  MemberGenderTxt.setText(AMemberList.get(View));
                  View++;
                  MemberBirthDateTxt.setText(AMemberList.get(View));
                  View++;
                  MemberEmailTxt.setText(AMemberList.get(View));
                  View++;
                  MemberPhoneTxt.setText(AMemberList.get(View));
                  View++;
                  MemberHomenumberTxt.setText(AMemberList.get(View));
                  View++;
                  MemberAddressTxt.setText(AMemberList.get(View));
                  View++;
                  MemberPositionTxt.setText(AMemberList.get(View));
                  View++;
             }
            }catch (FileNotFoundException ex) {       
            Logger.getLogger(NgoGui1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void Blacklist(){
        ...
        MemberLastNameTxt.setEditable(false);
        MemberGenderTxt.setEditable(false);
        MemberBirthDateTxt.setEditable(false);
        ...
        MemberPositionTxt.setEditable(false);
        ...
        try {
            BufferedReader BrAM = new BufferedReader(new FileReader("C:\\NGO Project\\"+TempOrganizationName+".txt"));
                ...
                while((ID = BrAM.readLine())!=null){
                    ...
                    if((countPosition >= 4) && (!AddMemberPositiontxt.getText().equalsIgnoreCase("Member"))){
    ...
    private void NextbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NextbtnActionPerformed
                  ...
                  if(View  >= (AMemberList.size()- 1)){
                  View = 0;
                  JOptionPane.showMessageDialog(null,View+"repeat");
                 }else if(View%9 == 0 ){
                  View++;
                  JOptionPane.showMessageDialog(null,View+"test");
                  }
                  MemberIdTxt.setText(AMemberList.get(View));
                  View++;
                  JOptionPane.showMessageDialog(null,AMemberList.get(View));
                  MemberFirstNameTxt.setText(AMemberList.get(View));
                  View++;
                  MemberLastNameTxt.setText(AMemberList.get(View));
                  View++;
    ...
    private void PrevbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrevbtnActionPerformed
                    JOptionPane.showMessageDialog(null,View);
                  if(View <= 0){
                  View = (AMemberList.size()-1);
                  JOptionPane.showMessageDialog(null,View+"repaat");
                 }else if(View%10 == 0 ){
                  View--;
                  JOptionPane.showMessageDialog(null,View+"test");
                  }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NgoGui1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
